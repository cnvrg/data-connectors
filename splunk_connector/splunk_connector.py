...
# The rate limit based on splunk's rate of dequeueing messages
# For details, refer to https://support.splunk.com/hc/en-us/articles/115002943027-Understanding-splunk-Rate-Limits-and-Message-Queues#h_01F0265SAZ9BYNPG0AQZ0AKRHZ
# NUM_OF_CALLS = 3
# TIME_PERIOD_SEC = 1

cnvrg_workdir = os.environ.get("CNVRG_WORKDIR", "/cnvrg")

service = binding.connect(token='')
...
def parse_parameters():
    ...
    parser.add_argument('--file_name', action='store', dest='file_name', required=False, default='splunk.csv', 
...
class splunk:
    ...
    def create_conversation(self, conv_name):
        ...
        Returns:
            conversation: new instance of conversation in splunk
        """
    ...
    def get_conversation(self, conv_id, leng_limit=None):
        ...
        Follows rate limits set by splunk.
        Args:
...
def main():
    ...
    splunk = SplunkCloud(args.auth_token, args.account_sid)
    messages = splunk.get_conversation(args.conv_id, args.leng_limit)
    ...
    # Store splunk csv as cnvrg dataset
